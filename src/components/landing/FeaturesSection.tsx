...
function GlassFeatureCard({ feature, index }: { feature: FeatureItem; index: number }) {
  return (
    ...
    >
      {/* Icon ring */}
      <div
        className="mb-6 w-12 h-12 flex items-center justify-center rounded-xl transition-all duration-300 group-hover:scale-110"
        style={{
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, rgba(110,198,198,0.06) 0%, transparent 70%)",
        }}
      />
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="mt-4 text-lg max-w-lg mx-auto" style={{ color: "rgba(255,255,255,0.38)" }}>
